...
#define INCLUDE "-I/opt/mysql/include/mariadb -I/opt/mysql/include/mariadb/mysql"
#define LIBS    "-L/opt/mysql/lib/mariadb/ -lmariadb "\
                "-lpthread -ldl -lm -lssl -lcrypto"
#define LIBS_SYS "-lpthread -ldl -lm -lssl -lcrypto"
#define CFLAGS  INCLUDE
#define VERSION "10.2.6"
#define PLUGIN_DIR "/opt/mysql/lib/mariadb/plugin"
#define SOCKET  "/tmp/mysql.sock"
#define PORT "3306"
#define TLS_LIBRARY_VERSION "OpenSSL 1.0.2g"
